...
function sortLowToHighPricing(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHighToLowPricing(hotel1, hotel2) {
...
function sortLeastToMostReviews(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortMostToLeastReviews(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    results = hotelsCopy.sort(sortLowToHighPricing);
  } else {
    results = hotelsCopy.sort(sortHighToLowPricing);
  }
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    results = hotelsCopy.sort(sortLowToHighRating);
  } else {
    results = hotelsCopy.sort(sortHighToLowRating);
  }
  res.json({ hotels: results });
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    results = hotelsCopy.sort(sortLeastToMostReviews);
  } else {
    results = hotelsCopy.sort(sortMostToLeastReviews);
  }
  res.json({ hotels: results });
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  results = hotels.filter(function (hotel) {
